...
export default class CreateEvent extends React.Component {
  ...
  validateForm = () => {
    const validLength =
      ...
      this.state.eventDescription.length > 0 &&
      this.state.eventDescription.length > 0 &&
      this.state.eventStreet.length > 0 &&
      this.state.eventCity.length > 0;
  ...
  handleSubmit = (event) => {
    ...
    const startDate =
      this.state.eventStartYear +
      "-" +
      this.state.eventStartMonth +
      "-" +
      this.state.eventStartDate;
    const endDate =
      this.state.eventEndYear +
      "-" +
      this.state.eventEndMonth +
      "-" +
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <Form.Group size="sm" controlId="eventStartMonth">
                ...
                <Form.Control
                  as="select"
                  onChange={(e) =>
                    this.setState({ eventStartMonth: e.target.value })
                  }
                >
              ...
              <Form.Group size="sm" controlId="eventStartYear">
                ...
                <Form.Control
                  as="select"
                  onChange={(e) =>
                    this.setState({ eventStartYear: e.target.value })
                  }
                >
              ...
              <Form.Group size="sm" controlId="eventEndMonth">
                ...
                <Form.Control
                  as="select"
                  onChange={(e) =>
                    this.setState({ eventEndMonth: e.target.value })
                  }
                >
                  <option value="01">Jan </option>
                  <option value="02">Feb</option>
              ...
              <Form.Group size="sm" controlId="eventEndYear">
                ...
                <Form.Control
                  as="select"
                  onChange={(e) =>
                    this.setState({ eventEndYear: e.target.value })
                  }
                >
                  <option value="2020">2020</option>
                  <option value="2021">2021</option>
              ...
              <Form.Group size="lg" controlId="eventStreet">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    this.setState({ eventStreet: e.target.value })
                  }
                />
              </Form.Group>
